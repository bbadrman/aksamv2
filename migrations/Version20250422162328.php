 ...
 */
final class Version20250422162328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840D1823061F FOREIGN KEY (contrat_id) REFERENCES contrat (id)');
